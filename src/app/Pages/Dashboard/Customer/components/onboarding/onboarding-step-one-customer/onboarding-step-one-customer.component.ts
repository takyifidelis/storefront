...
@Component({
  selector: 'app-onboarding-step-one-customer',
  standalone: true,
  imports: [
    RouterModule,
    MatInputModule,
  ...
  templateUrl: './onboarding-step-one-customer.component.html',
  styleUrl: './onboarding-step-one-customer.component.scss',
})
export class OnboardingStepOneCustomerComponent implements OnDestroy {
  constructor(
